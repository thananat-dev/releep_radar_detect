package com.releep.releep_radar_detect.utils;
...
public class ByteUtils {
    ...
    public static void printHexString(String str, byte[] bytes){
        com.axend.radarcommandsdk.utils.LogUtil.INSTANCE.d( str + "------->" + ByteUtils.bytesToHexString(bytes));
    }

    public static void printHexString(byte[] bytes){
        com.axend.radarcommandsdk.utils.LogUtil.INSTANCE.d(ByteUtils.bytesToHexString(bytes));
    }
...
//        }
    ...
    public static byte[] short2ByteBE(short x){
    ...
    public static byte[] short2ByteLE(short x){
        byte high = (byte) (0x00FF & (x>>8)); 
        byte low = (byte) (0x00FF & x); 
        byte[] bytes = new byte[2];
        bytes[1] = high;
